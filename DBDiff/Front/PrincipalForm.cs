    ...
    public partial class PrincipalForm : Form
    {
        ...
        */
        ...
        private void schemaTreeView1_OnSelectItem(string ObjectFullName)
        {
            ...
            var markers = new Marker[] { txtDiff.Markers[0], txtDiff.Markers[1], txtDiff.Markers[2], txtDiff.Markers[3], txtDiff.Markers[4], txtDiff.Markers[5], txtDiff.Markers[6] };
            ...
            markers[4].Symbol = MarkerSymbol.Plus;
            markers[5].Symbol = MarkerSymbol.Minus;
            markers[6].Symbol = MarkerSymbol.Bookmark;

            var indexes = new List<int>[] { new List<int>(), new List<int>(), new List<int>(), new List<int>(), new List<int>(), new List<int>(), new List<int>() };
            var index = 0;
        ...
        */
        ...
        private void btnCompare_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (optMSSQL.Checked) ProcessMSSQL();
...
" + exceptionMsg.ToString(), "Error " + errorLocation, MessageBoxButtons.OKCancel, MessageBoxIcon.Error))
        ...
        */
        ...
        private void optMSSQL_CheckedChanged(object sender, EventArgs e)
        {
            if (optMSSQL.Checked)
            {
                ShowMSSQL();
        ...
        private void InitializeScintillaControls(ScintillaNET.Scintilla scintilla)
        {
            // Reset the styles
